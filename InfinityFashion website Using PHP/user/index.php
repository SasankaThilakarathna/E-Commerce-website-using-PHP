									...
									<a href="#"><button type="button" class="dropdown-item"><i class="fa fa-user" aria-hidden="true"></i> &nbsp Your Account </button></a>
										<?php
											if(isset($_SESSION['user'])){
												echo $_SESSION['user'];
												echo "
													<a href='logout.php' class='text-warning text-decoration-none pe-2'><i class='fas fa-sign-out-alt'></i>Logout</a>
												";
											} else {
												...
												if(isset($_SESSION['user'])){
													echo $_SESSION['user'];
													echo "
														<a href='login.php' class='text-warning text-decoration-none pe-2'><i class='fas fa-sign-out-alt'></i>Login</a>
													";
												}
											}
										?>
...
<!-- Features -->
	...
	<div class="container">
			...
			<div class="features">
                    <a href="women.php"> 
                        <div class="fe-box">
                            <img src="../img/Dresses/dresswomen.png">
                            <h6>Women</h6>
                    </a>
                </div> 
			</div>
            ...
            <div class="features">
                    <a href="men.php"> 
                        <div class="fe-box">
                        <img src="../img/Dresses/dressmen.png">
					    <h6>Men</h6>
                    </a>
                </div> 
			</div>
			...
			<div class="features">
                    <a href="kids.php"> 
                        <div class="fe-box">
                        <img src="../img/Dresses/dresskid.png">
					    <h6>Kids</h6>
                    </a>
                </div> 
			</div>
                    ...
                    <form action='Insertcart.php' method='POST'>
                        <div class='card m-auto' style='width: 18rem;'>
                            ...
                            <div class='card-body text-center'>
                                ...
                                <p class='card-text text-warning fs-4 fw-bold'>Rs:<?php echo number_format($row["PPrice"],2); ?></p>
